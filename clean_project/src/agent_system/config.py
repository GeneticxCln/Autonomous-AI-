...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = Field(
        default="sqlite:///agent.db", description="Database connection string"
    )
    ...
    SECRET_KEY: str = Field(
        default="your-secret-key-change-in-production", description="Secret key for encryption"
    )
    ...
    USE_DOCKER_SANDBOX: bool = Field(
        default=False, description="Use Docker for code execution sandbox"
    )
